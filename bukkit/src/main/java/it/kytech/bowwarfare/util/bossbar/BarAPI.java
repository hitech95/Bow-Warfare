package it.kytech.bowwarfare.util.bossbar;

import it.kytech.bowwarfare.util.bossbar.nms.FakeDragon;
...
public class BarAPI {
     ...
     * Due to limitations in Minecraft this message cannot be longer than 64
     * characters.<br>
    ...
    public static void setMessage(final Player player, String message, int seconds) {
        ...
        timers.put(player.getUniqueId(), Bukkit.getScheduler().runTaskTimer(Bukkit.getServer().getPluginManager().getPlugin("BowWarfare-Reloaded"), new BukkitRunnable() {
