...
public class ForceStart implements SubCommand {
	...
	public boolean onCommand(Player player, String[] args) {
		...
		if (g.getState() != Game.GameState.WAITING && !player.hasPermission("bw.arena.restart")) {
	...
	public String help(Player p) {
		return "/bw forcestart - " + SettingsManager.getInstance().getMessageConfig().getString("messages.help.forcestart", "Forces the game to start");
	}

	@Override
	public String permission() {
		return "bw.arena.start";
	}
}