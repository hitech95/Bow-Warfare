    ...
    class Rollback implements Runnable {
        ...
        public void run() {
            ...
            if (data != null) {
                ...
                BowWarfare.$("Arena " + id + " reset. Rolled back " + totalRollback + " blocks in " + iteration + " iterations. Total time spent rolling back was " + time + "ms");
                game.resetCallback();
            }
        }
